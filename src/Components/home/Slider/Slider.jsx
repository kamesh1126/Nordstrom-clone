    ...
    <div className="springacc">
      ...
      <div className="springaccdiv">
        <div className="springaccimg">
          <img src="https://n.nordstrommedia.com/id/51a1cabc-fd85-47e8-8284-d93bb49e06b3.jpeg?h=501&w=536"></img>
          <h5>New Balance, adidas & More</h5>
          <p>New kicks under $50.</p>
        </div>
        <div className="springaccimg">
          <img src="https://n.nordstrommedia.com/id/d6d1b793-6be3-4723-b51f-50b584cfd9a5.jpeg?h=501&w=536"></img>
          <h5>Max Studio, Pleione, Melloday & More</h5>
          <p>Spring tops from $19.97.</p>
        </div>
        <div className="springaccimg">
          <img src="https://n.nordstrommedia.com/id/e85d2408-8f1b-4ae0-86d9-675a0ad11f3e.jpeg?h=501&w=536"></img>
